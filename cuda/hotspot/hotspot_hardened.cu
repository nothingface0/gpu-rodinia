	...
	__syncthreads();
        ...
        for (int i=0; i<iteration ; i++){ 
            ...
            if( IN_RANGE(tx, i+1, BLOCK_SIZE-i-2) &&  \
        		...
        		/* START of Lishan-add */
        		/* we only protect this line, because this is the actual computation.
        			So, if any error happens before this line, 
        			e.g., the value of temp_on_cuda[ty][tx] is wrong, 
        			      then this protection does not work.
        		   I am not sure how much improvement we can get by just protect this line.
        		   If the PVF does not improve much, then we can replicate the whole thread.
        		*/
                ...
                if (Cap+2.0) {
        		  ...
        		  */
        		  if (rep_1 != rep_2){
          			// fault happens in either rep_1 or rep_2, so rep_3 is error-free.
          		 	temp_t[ty][tx] = rep_3;
        		  }
        		  else{
          			// both rep_1 and rep_2 are correct; we don't care about rep_3
          			temp_t[ty][tx] = rep_1;
        		  }
