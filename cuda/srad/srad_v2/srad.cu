...
#ifdef COMPARE
	fprintf(stderr, "\t<filepath>   - results.txt file for results comparison\n");
#endif
	exit(1);
}
////////////////////////////////////////////////////////////////////////////////
...
#ifdef COMPARE
		results_filepath = argv[9];
		FILE *fp = NULL;
		if ((fp = fopen(results_filepath, "r")) == 0)
		{
...
// Comparison/printout of results
#ifdef COMPARE
	bool error = false;
	FILE *fp;
	char str[10000];
...
#endif
#ifdef COMPARE
		// -1 to remove the final space character
