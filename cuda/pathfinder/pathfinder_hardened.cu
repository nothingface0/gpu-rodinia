	...
	__syncthreads(); // [Ronny] Added sync to avoid race on prev Aug. 14 2012
        ...
        for (int i=0; i<iteration ; i++){ 
            ...
            if( IN_RANGE(tx, i+1, BLOCK_SIZE-i-2) &&  \
                  ...
                  int shortest_1 = MIN(left, up);
                  shortest_1 = MIN(shortest_1, right);
                  int index_1 = cols*(startStep+i)+xidx;
                  int result_1 = shortest_1 + gpuWall[index_1];

                  int shortest_2 = MIN(left, up);
                  shortest_2 = MIN(shortest_2, right);
                  int index_2 = cols*(startStep+i)+xidx;
                  int result_2 = shortest_2 + gpuWall[index_2];

                  int shortest_3 = MIN(left, up);
                  shortest_3 = MIN(shortest_3, right);
                  int index_3 = cols*(startStep+i)+xidx;
                  int result_3 = shortest_3 + gpuWall[index_3];
