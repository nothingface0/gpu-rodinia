...
//	read_graphics(	"../../../data/srad/image.pgm",
	...
	cudaMalloc((void **)&d_sums, mem_size*3); // L
	cudaMalloc((void **)&d_sums2, mem_size*3); // L
	...
	// Lishan's note
	// output: d_sums, d_sums2 size: 16384
	...
	check_correctness<<<dimGridHardening1, dimBlockHardening>>>(d_sums, Ne);
	check_correctness<<<dimGridHardening1, dimBlockHardening>>>(d_sums2, Ne);
