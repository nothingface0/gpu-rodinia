...
//	read_graphics(	"../../../data/srad/image.pgm",
	...
	cudaMalloc((void **)&d_I, mem_size*3); // modified by Lishan
	...
	duplicate_input_data<<<dimGridHardening1, dimBlockHardening>>>(d_I, Ne);

	blocks.y = 3;
	srad2<<<blocks, threads>>>(lambda, Nr, Nc, Ne, d_iN, d_iS, d_jE, d_jW, d_dN, d_dS, d_dW, d_dE, d_c, d_I);
	blocks.y = 1;

	check_correctness<<<dimGridHardening1, dimBlockHardening>>>(d_I, Ne);
